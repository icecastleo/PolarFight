...
@interface CharacterInfoView() {
    CCLabelTTF *levelLbBM;
    CCLabelTTF *hpLbBM;
    CCLabelTTF *attackLbBM;
    CCLabelTTF *defenseLbBM;
    CCLabelTTF *speedLbBM;
    CCLabelTTF *moveSpeedLbBM;
    CCLabelTTF *moveTimeLbBM;
}
