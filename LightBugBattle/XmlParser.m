...
//Custom method to XML with attributes
-(NSString *)toXml:(id)object andTag:(NSString *)tag attributeName:(NSString *)aName attributeValue:(NSString *)aValue
{
	...
	//[objectElement addNamespace:[GDataXMLNode namespaceWithName:nil stringValue:nameSpace]];
	[objectElement addAttribute:[GDataXMLNode attributeWithName:aName stringValue:aValue]];
	...
	NSString *headerString = [XmlHeaderHelper generateXmlHeader:tag and:aValue];
